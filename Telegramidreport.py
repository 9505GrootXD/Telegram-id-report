...
to(
    f"\033[31;m TOOL >> \033[1;36mTELEGRAM REPORT SCRIPT\n\033[1;31m DEVELOPER >>\033[1;33m ⋆⎯፝֟፝֟⎯᪵ 𝆺꯭𝅥𝗦𝗶꯭𝗹𝗲꯭𝗻꯭𝗧 ꯭𝗕꯭𝗼꯭𝗬꯭🤨꯭𝆺꯭𝅥⎯‌⎯ ⋆ \n\033[31;m JOIN >> \033[1;36m @DarkLightOwner  \n")
def R(m,email,num):
...
while True:
 ...
 R(m,email,num)
# @DarkLightOwner  oN: @DarkLightOwner 🔥❄. 
